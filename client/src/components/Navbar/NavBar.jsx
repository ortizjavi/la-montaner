        ...
        <section>
          <ul className="navbar-ul">
            <li className="navbar-section">
              <input
                className={`${state === "vertodos" ? "actived" : "Nav-button"}`}
                type="button"
                id="vertodos"
              ...
              />
              <input
                className={`${state === "cervezas" ? "actived" : "Nav-button"}`}
                type="button"
                id="cervezas"
                value="Cervezas"
                onClick={(e) => handleCategory(e)}
              ...
              <input
                className={`${
                  state === "conservas" ? "actived" : "Nav-button"
                }`}
                type="button"
                id="conservas"
                value="Conservas"
              ...
              <input
                className={`${
                  state === "merchandising" ? "actived" : "Nav-button"
                }`}
                type="button"
                id="merchandising"
                value="Merchadising"
              ...
              />
              <input
                className={`${state === "otros" ? "actived" : "Nav-button"}`}
                type="button"
                value="Otros"
                id="otros"
                onClick={(e) => handleCategory(e)}
