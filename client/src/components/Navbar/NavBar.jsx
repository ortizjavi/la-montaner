      ...
      <nav className="nav-container">
        ...
        <ul className="nav-ul">
          <li className="list-item">
            ...
            >
              <option id="range1" value="vertodos">
                Todos los productos
              </option>
              <option id="range2" value="cervezas">
                Cervezas
              </option>
              <option id="range3" value="conservas">
                Conservas
              </option>
              <option id="range3" value="merchandising">
                Merchandising
              </option>
              <option id="range3" value="otros">
                Otros
              </option>
            </select>
          </li>
